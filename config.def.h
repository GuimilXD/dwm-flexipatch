...
static const char *statuscmd[] = { "/bin/zsh", "-c", NULL, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_m,     spawn,                 SHCMD("xmouseless") },
	{ MODKEY,             XK_Print,     spawn,                 SHCMD("maim --select | xclip -selection clipboard -t image/png") },
